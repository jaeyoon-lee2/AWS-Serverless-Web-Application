...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ii73o1etm0.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.eventManagerOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var eventManagerOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(eventManagerOptionsRequest, authType, additionalParams, config.apiKey);
    };
